...
create table accounts(id int8 generated by default as identity, account_number varchar(255), account_type varchar(255), balance numeric(19, 2), person_id int8, primary key (id));
